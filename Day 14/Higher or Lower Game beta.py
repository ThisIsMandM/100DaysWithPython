...
def which_is():
    ...
    print(
        f"Compare A: {random_name1['name']}, a {random_name1['description']}, from {random_name1['country']}"
    )
    print(vs)
    print(
        f"Compare B: {random_name2['name']}, a {random_name2['description']}, from {random_name2['country']}"
    )
